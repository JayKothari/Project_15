...
#define PERIOD_1	(u_NSEC*400)
#define PERIOD_2	(u_NSEC*500)
#define PERIOD_3	(u_NSEC*600)
#define PERIOD_4	(u_NSEC*700)
#define PERIOD_5	(u_NSEC*800)

#define WAKE_TIME	(u_NSEC*1000)
